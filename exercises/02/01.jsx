...
class App extends React.Component {
  ...
  render() {
    return (
      <div className="w-1/4">
        <input type="text" className='appearance-none block w-full bg-grey-lighter text-grey-darker border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white' onChange={this.onChange}/>
        <label>{this.state.team}</label>
      </div>
    );
  }
}
