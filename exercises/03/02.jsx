...
class Row extends React.Component {
  render() {
    const { className, team, functions, status, name, sources } = this.props;
    ...
    return (
      ...
      <div className={css.join(' ')}>
        ...
        <DataColumn id="functions"> {functions && functions.length ? functions.join(', ') : '-'} </DataColumn>
        <DataColumn id="sources"> {sources && sources.length ? sources.join(', ') : '-'} </DataColumn>
